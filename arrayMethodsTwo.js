...
const newCities = cities.filter(ele => ele.endsWith(`i`))
...
//   if(ele.color.includes(`red`)){
//     console.log(`The fruit with the index ${ind} is an apple`)
//   } else if (ele.color.includes(`orange`)){
//     console.log(`The fruit with the index ${ind} is an Orange`)
//   }else {
//     console.log(`The fruit with index ${ind} is neither apple or orange`)
//   }
// })
...
const totalPrice = foods.filter(ele => ele.tags.includes(`rice`)).reduce((acc, curr) => acc + curr.price,0)
console.log(`The total price $${totalPrice}`)


// THE TOTAL
// $ node arrayMethodsTwo.js 
// The total price $36